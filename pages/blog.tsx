    ...
    <>
      ...
      <main className="py-12">
        <div className="container">
          <h1 className="font-bold text-center text-2xl mb-6">Our Blog</h1>
          ...
          <div className="flex flex-wrap justify-center">
            {posts.map((post, index) => {
              ...
              return (
                <div
                  className="w-full md:max-w-[50%] lg:max-w-[calc(100%/3)] p-3"
                  key={index}
                >
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex justify-between items-center flex-wrap">
                        <div className="flex items-center">
                          ...
                          />
                          <div>
                            <p className="font-semibold text-[12px] leading-none">
                              {author}
                            </p>
                        ...
                        <Link
                          href={`/posts/${slug}`}
                          className="my-2 border border-[#6D27F9] rounded-full py-1.5 px-4 text-[12px] hover:bg-gradient-to-r hover:from-[#A382E5] hover:to-[#60C3E2] hover:text-white"
                        >
                          Read more
