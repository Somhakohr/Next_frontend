...
import slide_2 from "public/images/homebanner-card-2.svg";
      ...
      <main>
          ...
          <div className="max-w-[1200px] w-full px-4 mx-auto flex flex-wrap items-center">
            <div className="w-full lg:max-w-[50%] py-10">
              <div className="w-full max-w-[500px] mx-auto lg:mx-0 text-center lg:text-left">
                <h1 className="text-[#646464] text-4xl md:text-5xl font-semibold mb-12">
                  Are You <span className="text-[#60C3E2]">Hiring</span> the
                  Right Talent ?
                </h1>
                <h2 className="text-[#646464] text-2xl font-semibold relative inline-block mb-12">
                  <span className="relative z-10">
                    <span className="text-black">Discover</span>, &nbsp;
                    <span className="text-[#6D27F9]">Connect</span>
                    &nbsp; & &nbsp;
                    <span className="text-[#60C3E2]">Network</span>
                  </span>
                  <span className="h-30 rounded-[30px] w-full bg-[#D9D9D9] absolute bottom-[-10px] right-0 md:right-[-40px] opacity-20">
                    {" "}
                    &nbsp;{" "}
                  </span>
                </h2>
                <p className="font-light text-[#646464] text-lg">
                  Make your job search easier with trackable resumes and
        ...
        <section className="py-10">
          <div className="max-w-[1200px] w-full px-4 mx-auto">
            <h3 className="text-[#60C3E2] text-sm text-center mb-4">
              Explore high Demand jobs in Corporates{" "}
            </h3>
            <h2 className="text-[#646464] text-xl md:text-3xl text-center font-medium mb-6">
              We Work On Different Job Functions
            </h2>
            <div className="flex flex-wrap mx-[-15px]">
              {jobFunctions.map((jobFunctions, i) => (
                <div
                  className="w-full md:max-w-[calc(100%/3)] p-[15px]"
                  key={i}
                >
        ...
        <section className="py-10 bg-white" id="protocol">
          <div className="container">
            <h2 className="text-xl md:text-3xl text-center font-medium mb-8">
              Somhako <span className="text-[#60C3E2]">Protocol</span>
            </h2>
            <div className="w-full max-w-[900px] mx-auto">
              <Image
                src={protocolListDesktop}
                alt="Protocol"
                className="mx-auto hidden md:block"
              />
              <Image
                src={protocolListMobile}
                alt="Protocol"
                ...
                <div className="flex items-center">
                  ...
                  <aside className="w-[calc(100%-100px)]">
                    ...
                    <p className="text-[#646464] text-[12px]">
                      Sign Up and fill out all your profile details , including
                ...
                <div className="flex items-center flex-row-reverse">
                  ...
                  <aside className="w-[calc(100%-100px)]">
                    ...
                    <p className="text-[#646464] text-[12px]">
                      ...
                      availbookmark-label , but the majority alteration in some
                      form
                    </p>
                  </aside>
                </div>
              ...
              <div className="w-full md:max-w-[400px]">
                <div className="flex items-center">
                  ...
                  <aside className="w-[calc(100%-100px)]">
                    ...
                    <p className="text-[#646464] text-[12px]">
                      Discover jobs in top global companies and get natched to
                      the right roles
                    </p>
                  </aside>
                </div>
        ...
        <section className="py-10 bg-white">
          <div className="max-w-[1200px] w-full px-4 mx-auto">
            ...
            <p className="text-[#646464] font-light text-center mb-4">
              $OM is a utility token that is going to be used in the Somhako
              protocol for various different purposes and currently will be on
              the polygon mainnet.
            </p>
          ...
          <div className="container">
            ...
            <div className="flex flex-wrap mx-[-15px]">
              {featuresList.map((featuresList, i) => (
                <div
                  className="w-full sm:max-w-[calc(100%/2)] md:max-w-[calc(100%/3)] lg:max-w-[calc(100%/5)] px-[15px] mb-[30px]"
                  key={i}
                >
                  <div className="border border-[#A382E5] border-b-8 rounded-[25px] shadow-normal p-4 h-full text-center">
                    ...
                    <p className="text-[#646464] font-light text-[12px]">
                      {featuresList.desc}
                    </p>
                  </div>
                </div>
            ...
            <div className="w-full md:max-w-[60%] shadow-normal bg-white rounded-[40px] rounded-br-[100px] md:rounded-br-[150px] overflow-hidden relative z-10">
              ...
              <div className="p-8">
                <h4 className="font-semibold text-2xl mb-6">
                  Be a Part of <br />
                  <span className="text-[#6D27F9]">Somhako</span>
                </h4>
                <p className="text-[#646464] font-light mb-8">
                  Get started by signing up with and deep dive into the HR
                  product in Web 3 Space{" "}
                </p>
                <Link
                  href="/marketplace/auth/signup"
                  className="inline-block mb-6 text-center bg-gradient-to-r from-[#6D27F9] to-[#9F09FB] text-white font-bold rounded-full py-2.5 px-6 md:min-w-[150px] transition-all hover:from-[#391188] hover:to-[#391188]"
                >
                  Sign Up
                </Link>
              </div>
          ...
          <div className="max-w-[900px] w-full px-4 mx-auto">
            <div className="flex flex-wrap items-center">
              ...
              <div className="w-full lg:max-w-[50%] text-white">
                <h2 className="mb-6 font-light text-2xl text-center">
                  Untill then <span className="font-bold">Join Discord</span>
                </h2>
                <Link
                  href="https://discord.gg/934TJUe6BF"
                  target="_blank"
                  rel="noreferrer"
                  className="block text-white border border-white rounded-[30px] min-w-[200px] text-center py-2 px-4 hover:bg-white hover:text-[#6D27F9]"
                >
                  Join Now <i className="fa-brands fa-discord ml-2"></i>
                </Link>
              </div>
            </div>
          </div>
