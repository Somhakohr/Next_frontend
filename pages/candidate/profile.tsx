                  ...
                  <div className="bg-white shadow-normal border border-teal-400 rounded-[30px] p-8 mb-6">
                    ...
                    <div className="relative">
                      ...
                      <textarea
                        ...
                        className="w-full rounded-[25px] h-[120px] border-slate-300 resize-none pb-6"
                        value={summary}
                        onChange={(e) => setSummary(e.target.value)}
                        onBlur={(e) => setFSummary(e.target.value)}
                      ></textarea>
                    ...
                    <div className="flex flex-wrap justify-between">
                      <div className="w-full lg:w-[47%] mb-6">
                        ...
                        <input
                          ...
                          className="w-full rounded-full border-slate-300"
                          value={preJobtype}
                          onChange={(e) => setPreJobType(e.target.value)}
                          onBlur={(e) => setFPreJobType(e.target.value)}
                        />
                      </div>
                      <div className="w-full lg:w-[47%] mb-6">
                        ...
                        <select
                          ...
                          disabled={!serveNP}
                          value={noticeP}
                          onChange={(e) => setNoticeP(e.target.value)}
                        >
                          ...
                          {lang.map((lang, i) => (
                            ...
                            >
                              ...
                              <span className="pl-1 text-[10px] flex text-[#FEF401] mt-[2px]">
                                ...
                                {lang.experties ==
                                  "Native or bilingual profeciency" && (
                                  <>
                                    <i className="fa-solid fa-star ml-1"></i>
                                    <i className="fa-solid fa-star ml-1"></i>
                                    <i className="fa-solid fa-star ml-1"></i>
                    ...
                    <div>
                      <div className="mb-6">
                        ...
                        <input
                          ...
                          className="w-full rounded-full border-slate-300"
                          value={alang}
                          onChange={(e) => setALang(e.target.value)}
                        />
                      </div>
                      <div className="mb-6">
                        <label
                        ...
                        <select
                          id="chooseLangProfeciency"
                          className="w-full rounded-full border-slate-300"
                          value={aprof}
                          onChange={(e) => setAProf(e.target.value)}
                        >
                          <option value="Elementary profeciency">
                            Elementary profeciency
                          </option>
                          <option value="Limited profeciency">
                            Limited profeciency
                          </option>
                          <option value="Professional profeciency">
                            Professional profeciency
                          </option>
                          <option value="Native or bilingual profeciency">
                            Native or bilingual profeciency
                          </option>
                        </select>
                      </div>
                  ...
                  <div className="p-8">
                    ...
                    <div>
                      ...
                      <div className="mb-6">
                        ...
                        <select
                          id="choosesSkillsProfeciency"
                          className="w-full rounded-full border-slate-300"
                          value={sprf}
                          onChange={(e) => setSProf(e.target.value)}
                        >
