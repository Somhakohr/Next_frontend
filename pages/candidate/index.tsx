          ...
          <main className="pt-8">
            <div className="container flex flex-wrap">
              <div className="w-full lg:w-[60%] lg:pr-8">
                  ...
                  <div className="flex flex-wrap justify-between items-start mb-6">
                    <div className="w-full md:w-[65%] md:pr-10 mb-3 md:mb-0">
                      <div className="w-full max-w-[320px] mb-2">
                        ...
                        <div className="rounded-full bg-[#FFF0EE] p-1">
                          <div
                            className={`bg-gradient-to-r from-[#F295EF] to-[#4D94E8] transition-all delay-150 rounded-full w-[80%] h-[25px]`}
                    ...
                    <div className="w-full md:w-[35%] flex flex-wrap md:justify-end">
                      ...
                      <div className="p-3 rounded-lg bg-[#D1FBD0] text-center mb-2 ml-4">
                        <span className="block mb-1">
                          10{" "}
                          <i className="fa-solid fa-eye text-[#274046] ml-2"></i>
                        </span>
                        <p className="font-medium text-[12px] text-black">
                          Jobs Viewed
                        </p>
                ...
                <div className="mb-8 py-4 px-8 bg-white shadow-normal rounded-[20px]">
                  ...
                  <div className="bg-[#f5f5f5] rounded-[20px] p-6 flex flex-wrap justify-between">
                    <div className="w-full md:max-w-[40%] mb-4 md:mb-0">
                      ...
                      <p>
                        Earn 100 <span className="text-[#6D27F9]">Coin</span> to
                ...
                <div className="mb-8 py-4 px-8 bg-white shadow-normal rounded-[20px]">
                  <h2 className="font-semibold text-xl text-3xl mb-10">
                    Talent Center
                  </h2>
                  <Tabs>
                    <div className="mb-4">
              ...
              <div className="w-full lg:w-[40%]">
                <div className="mb-8 py-4 px-8 bg-white shadow-normal rounded-[20px]">
                  ...
                  <div className="flex flex-wrap justify-between items-center mb-10">
                    ...
                    />
                    <Image
                      src={LaunchingGraphic}
                      alt="Somhako"
                      className="max-w-[100px] w-full my-6"
                    />
                  </div>
                  <p className="text-2xl font-medium mb-10">
                    We will let you know when we are{" "}
                    <span className="text-[#6D27F9]">Launching</span>
                  </p>
                  <h5 className="text-3xl mb-8">
                    Untill Then <br />
                    <span className="text-[#5865F2] font-semibold text-4xl">
                      Join Discord
                    </span>
                  </h5>
                ...
                <div className="mb-8 py-4 px-8 bg-white shadow-normal rounded-[20px]">
                  ...
                  <p className="mb-6">
                    ...
                    <span className="text-[#6D27F9]">Learning</span> <br />
                    Center
                  </p>
                  <Slider {...settings} className="sliderArrows">
                    {learningSlides.map((learningSlides, i) => (
                      <div key={i}>
                        <Link
                          href={learningSlides.url}
                          className="relative rounded-lg p-2 flex items-end justify-center h-[120px] overflow-hidden mr-2 after:content-[''] after:w-full after:h-full after:bg-black after:opacity-30 after:absolute after:left-0 after:bottom-0"
                        >
                          <Image
                            src={learningSlides.img}
                            alt="Slide"
                            className="absolute left-0 top-0 w-full h-full object-cover"
                          />
                          <span className="relative z-[1] text-white text-sm font-semibold">
                            {learningSlides.title}
                          </span>
                        </Link>
                      </div>
                    ))}
                  ...
                  <div className="flex flex-wrap">
                    <div className="p-6 relative w-full md:max-w-[50%]">
                      ...
                      <div className="relative">
                        <button
                          type="button"
                          className="rounded-full my-2 bg-white w-full p-2 px-6 flex items-center justify-between hover:bg-black hover:text-white"
                        >
