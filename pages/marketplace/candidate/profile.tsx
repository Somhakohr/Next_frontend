                ...
                <div className="container">
                    ...
                    <div className="relative pt-12 xl:pt-0 xl:px-20">
                        <div className="absolute left-0 top-[7px]">
                            <button type="button" onClick={(e)=>{router.push("/marketplace/candidate")}} className="rounded-full bg-black text-white p-4 mr-4 w-[25px] h-[25px] flex items-center justify-center">
