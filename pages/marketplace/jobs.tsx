      ...
      <main className="py-8">
        ...
        <section className="container flex flex-wrap">
          <div
            className={
              sidebarToggle
                ? "fixed z-[9] left-0 top-0 w-full h-full bg-[#0000006b] block"
                : "fixed z-[9] left-0 top-0 w-full bg-[#0000006b] hidden"
            }
          ...
          <div
            className={
              sidebarToggle
                ? "w-full lg:max-w-[300px] p-4 lg:p-0 fixed z-10 lg:static right-0 bottom-0 text-right lg:text-left"
                : "w-full lg:max-w-[300px] p-4 lg:p-0 fixed z-10 lg:static right-0 bottom-0 text-right lg:text-left"
            }
          >
            <div
              className={
                sidebarToggle
                  ? "block overflow-hidden h-full bg-white shadow-normal border border-teal-400 rounded-[30px] mb-[15px] lg:mb-0"
                  : "hidden lg:block overflow-hidden h-full bg-white shadow-normal border border-teal-400 rounded-[30px] mb-[15px] lg:mb-0"
              }
            >
              {skeleton2 ? (
                <div className="w-full lg:max-w-[300px]">
                  ...
                  {userType == "Candidate" && (
                    <TabPanel>
                      <ChatBot
                        ...
                        setJobList2={setJobList2}
                        setskeleton2={setskeleton2}
                        setskeleton1={setskeleton1}
                        skeleton2={skeleton2}
                        skeleton1={skeleton1}
                        data={data}
                        setData={setData}
            ...
            <button
              ...
              className="lg:hidden shadow-normal bg-[#6D27F9] text-white rounded-full w-[60px] h-[60px] text-2xl"
            >
          ...
          {skeleton1 ? (
            ...
            <div className="w-full lg:max-w-[calc(100%-300px)] lg:pl-4">
              <div className="bg-white shadow-normal border rounded-[30px] p-6">
                <h2 className="font-semibold text-xl md:text-3xl mb-4 text-center md:text-left">
