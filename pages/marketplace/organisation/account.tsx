...
function OrganisationAccount(props) {
  ...
  async function deleteGallery(val) {
    await axiosInstanceAuth2
      .delete(
        "/organisation/organisationgallery/" +
          userObj["orefid"] +
          "/" +
          val +
          "/delete/"
                ...
                <div className="bg-white shadow-normal border border-teal-400 rounded-[25px] py-8 px-4">
                  <ul className="flex flex-wrap items-center justify-between text-sm">
                    <li className="w-[49%] lg:w-full">
                      <Link
                        href="#about"
                        className="flex items-center py-2 px-3 lg:px-8 hover:bg-[#6D27F9] hover:text-white rounded-lg my-2"
                      >
                        About Company
                      </Link>
                    </li>
                    ...
                    <li className="w-[49%] lg:w-full">
                      <button
                        ...
                        className="flex items-center py-2 px-3 lg:px-8 hover:bg-[#6D27F9] hover:text-white rounded-lg my-2 w-full"
                      >
                        Change Password
                      </button>
                    </li>
                    <li className="w-[49%] lg:w-full">
                      <button
                        ...
                        className="flex items-center py-2 px-3 lg:px-8 bg-red-400 text-white hover:bg-red-700 hover:text-white rounded-lg my-2 w-full"
                      >
                        Delete Account
                      </button>
                    </li>
              ...
              <div className="w-full lg:max-w-[calc(100%-250px)] lg:pl-6">
                  ...
                  <div className="flex flex-wrap justify-between">
                    ...
                    <div className="w-full lg:w-[47%] mb-6">
                      ...
                      {/* <select
                        ...
                        className="w-full rounded-full border-slate-300"
                        value={opestatus}
                        onChange={(e) => setOpeStatus(e.target.value)}
                      >
                        <option value="">Select Status</option>
                ...
                >
                  <div className="flex flex-wrap items-center justify-between mb-3">
                    ...
                    <button
                      type="button"
                      className="my-2 border border-[#6D27F9] rounded-full py-1 px-4 text-sm hover:bg-gradient-to-r hover:from-[#A382E5] hover:to-[#60C3E2] hover:text-white"
                      onClick={() => galleryImagesAdd(true)}
                    >
                      Add Images
                    </button>
                  </div>
                  {gallery.length > 0 ? (
                    ...
                    <div
                      className="md:border border-slate-300 rounded-[30px] md:py-6 md:px-8 min-h-[250px] flex items-center justify-center cursor-pointer"
                      onClick={() => galleryImagesAdd(true)}
                    >
                      <Image
                        src={uploadImages}
                      ...
                      <div className="p-8">
                        <div className="flex items-center justify-between mb-8">
                          ...
                          <button
                            type="button"
                            className="leading-none"
                            onClick={() => galleryImagesAdd(false)}
                          >
                            <i className="fa-solid fa-xmark"></i>
                          </button>
                        </div>
                        <div className="flex items-center justify-center mb-6">
                          <label
                            ...
                            className="cursor-pointer w-[150px] h-[150px] rounded-lg bg-gray-200 p-2 flex items-center justify-center flex-col"
                          >
