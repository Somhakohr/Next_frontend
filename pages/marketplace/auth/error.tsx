...
export default function SignIn() {
  ...
  const errdict = {
    ...
    Callback:
      "Error in the OAuth callback handler route, Account already exist..",
    OAuthAccountNotLinked:
      "If the email on the account is already linked, but not with this OAuth account",
    EmailSignin: "Sending the e-mail with the verification token failed",
    CredentialsSignin:
      "The authorize callback returned null in the Credentials provider. We do not recommend providing information about which part of the credentials were wrong, as it might be abused by malicious hackers.",
    SessionRequired:
          ...
          <div className="mx-auto max-w-[1200px] w-full px-4 flex flex-wrap items-center">
            ...
            <div className="w-full lg:w-[60%]">
              <div className="bg-white shadow-normal border border-teal-400 rounded-[30px] p-10 lg:px-24 min-h-[550px] flex flex-col justify-center">
                <h1 className="font-medium text-3xl mb-12">Error</h1>
                <p className="font-medium mb-2 leading-none inline-block">
                  {errorMsg}
                </p>
                <button
                  type="button"
