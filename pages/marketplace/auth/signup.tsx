                  ...
                  <div className="bg-white shadow-normal border border-teal-400 rounded-[30px] p-10 lg:px-16 min-h-[550px] flex flex-col justify-center">
                      ...
                      <aside>
                        ...
                        <form>
                          ...
                          <div className="flex flex-wrap items-center justify-between md:flex-row flex-col">
                            ...
                            <span>Already have an account? <Link href="/marketplace/auth/signin" className="my-3 inline-block text-[#6D27F9] hover:underline">Sign In</Link></span>
                          </div>
                        </form>
                      </aside>
                      </>
                    ...
                    <>                    
                      <aside>
                        ...
                        <div className="text-center">
                          <Link href="/marketplace/auth/signin" className="text-[#6D27F9] hover:underline">Sign In</Link>
                        </div>
                      </aside>
                    </>}    
