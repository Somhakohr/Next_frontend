    ...
    <>
        ...
        <ul className="flex flex-wrap justify-between">
          <li className="w-[49%] lg:w-full">
            <Link
              ...
              className={`flex items-center py-2 px-3 lg:px-8 rounded-lg my-1 hover:bg-[#6D27F9] hover:text-white ${
                router.pathname == "/marketplace/organisation"
                  ? "bg-[#6D27F9] text-white"
                  : ""
              }`}
            >
          ...
          <li className="w-[49%] lg:w-full">
            <Link
              href="/marketplace/organisation/jobs"
              className={`flex items-center py-2 px-3 lg:px-8 rounded-lg my-1 hover:bg-[#6D27F9] hover:text-white ${
                router.pathname == "/marketplace/organisation/jobs"
                  ? "bg-[#6D27F9] text-white"
                  : ""
              }`}
            >
          ...
          <li className="w-[49%] lg:w-full">
            <Link
              href="/marketplace/organisation/applicants"
              className={`flex items-center py-2 px-3 lg:px-8 rounded-lg my-1 hover:bg-[#6D27F9] hover:text-white ${
                router.pathname == "/marketplace/organisation/applicants"
                  ? "bg-[#6D27F9] text-white"
                  : ""
              }`}
            >
          ...
          <li className="w-[49%] lg:w-full">
            <button
              type="button"
              onClick={() => scoutComingsoonPopupOpen(true)}
              className="w-full flex items-center py-2 px-3 lg:px-8 hover:bg-[#6D27F9] hover:text-white rounded-lg my-2"
            >
      ...
      <Transition.Root show={scoutComingsoonPopup} as={Fragment}>
        <Dialog
          ...
          onClose={scoutComingsoonPopupOpen}
        >
          <Transition.Child
            as={Fragment}
                  ...
                  <div className="p-8">
                    <div className="flex items-center justify-between mb-8">
                      ...
                      <button
                        ...
                        onClick={() => scoutComingsoonPopupOpen(false)}
                      >
                    ...
                    <div className="text-center">
                      ...
                      <h4 className="text-[#6D27F9] text-2xl font-bold">
                        Coming Soon
                      </h4>
                    </div>
                  </div>
